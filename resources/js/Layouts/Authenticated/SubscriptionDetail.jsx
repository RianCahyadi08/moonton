export default function SubscriptionDetail({
    ...
    // console.log('before value remaning active days ' + remainingActiveDays)
    // console.log('value active days ' + activeDays)
    const remainingDay = activeDays - remainingActiveDays;
    // console.log('Nilai remaining day sekarang ' + remainingDay)
    const loadingProgress = () => {
        const progress = remainingDay / activeDays;

        // console.log('nilai progress sekarang ' + progress);
        if (progress < 0.25) {
            return 'w-3/12';
